...
s32 EffectSsGRipple_Init(GameState* game, u32 index, EffectSs* this, void* initParamsx);
void EffectSsGRipple_Update(GameState* game, u32 index, EffectSs* this);
void EffectSsGRipple_Draw(GameState* game, u32 index, EffectSs* this);
