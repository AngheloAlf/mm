...
s32 EffectSsHahen_Init(GameState* game, u32 index, EffectSs* this, void* initParamsx);
void EffectSsHahen_Update(GameState* game, u32 index, EffectSs* this);
void EffectSsHahen_Draw(GameState* game, u32 index, EffectSs* this);
