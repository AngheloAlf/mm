...
s32 EffectSsKFire_Init(GameState* game, u32 index, EffectSs* this, void* initParamsx);
void EffectSsKFire_Update(GameState* game, u32 index, EffectSs* this);
void EffectSsKFire_Draw(GameState* game, u32 index, EffectSs* this);
