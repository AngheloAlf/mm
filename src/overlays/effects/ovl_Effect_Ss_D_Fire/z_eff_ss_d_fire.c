...
s32 EffectSsDFire_Init(GameState* game, u32 index, EffectSs* this, void* initParamsx);
void EffectSsDFire_Update(GameState* game, u32 index, EffectSs* this);
void EffectSsDFire_Draw(GameState* game, u32 index, EffectSs* this);
