...
void EnMkk_Init(Actor* thisx, GameState* game);
void EnMkk_Destroy(Actor* thisx, GameState* game);
void EnMkk_Update(Actor* thisx, GameState* game);
void EnMkk_Draw(Actor* thisx, GameState* game);
