...
void EnIk_Init(Actor* thisx, GameState* game);
void EnIk_Destroy(Actor* thisx, GameState* game);
void EnIk_Update(Actor* thisx, GameState* game);
void EnIk_Draw(Actor* thisx, GameState* game);
