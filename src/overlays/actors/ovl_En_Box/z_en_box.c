...
void EnBox_Init(Actor* thisx, GameState* game);
void EnBox_Destroy(Actor* thisx, GameState* game);
void EnBox_Update(Actor* thisx, GameState* game);
void EnBox_Draw(Actor* thisx, GameState* game);
