...
void EnAm_Init(Actor* thisx, GameState* game);
void EnAm_Destroy(Actor* thisx, GameState* game);
void EnAm_Update(Actor* thisx, GameState* game);
void EnAm_Draw(Actor* thisx, GameState* game);
