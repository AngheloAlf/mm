...
void EnMThunder_Init(Actor* thisx, GameState* game);
void EnMThunder_Destroy(Actor* thisx, GameState* game);
void EnMThunder_Update(Actor* thisx, GameState* game);
void EnMThunder_Draw(Actor* thisx, GameState* game);
