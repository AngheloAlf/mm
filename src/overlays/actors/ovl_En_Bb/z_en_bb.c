...
void EnBb_Init(Actor* thisx, GameState* game);
void EnBb_Destroy(Actor* thisx, GameState* game);
void EnBb_Update(Actor* thisx, GameState* game);
void EnBb_Draw(Actor* thisx, GameState* game);
