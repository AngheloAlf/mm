...
void OceffWipe7_Init(Actor* thisx, GameState* game);
void OceffWipe7_Destroy(Actor* thisx, GameState* game);
void OceffWipe7_Update(Actor* thisx, GameState* game);
void OceffWipe7_Draw(Actor* thisx, GameState* game);
