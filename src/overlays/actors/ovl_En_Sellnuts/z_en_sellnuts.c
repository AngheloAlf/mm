...
void EnSellnuts_Init(Actor* thisx, GameState* game);
void EnSellnuts_Destroy(Actor* thisx, GameState* game);
void EnSellnuts_Update(Actor* thisx, GameState* game);
void EnSellnuts_Draw(Actor* thisx, GameState* game);
