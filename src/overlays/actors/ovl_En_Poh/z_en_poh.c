...
void EnPoh_Init(Actor* thisx, GameState* game);
void EnPoh_Destroy(Actor* thisx, GameState* game);
void EnPoh_Update(Actor* thisx, GameState* game);
void EnPoh_Draw(Actor* thisx, GameState* game);
