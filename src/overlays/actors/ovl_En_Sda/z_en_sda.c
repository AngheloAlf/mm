...
void EnSda_Init(Actor* thisx, GameState* game);
void EnSda_Destroy(Actor* thisx, GameState* game);
void EnSda_Update(Actor* thisx, GameState* game);
void EnSda_Draw(Actor* thisx, GameState* game);
