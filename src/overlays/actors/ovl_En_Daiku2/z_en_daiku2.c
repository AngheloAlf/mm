...
void EnDaiku2_Init(Actor* thisx, GameState* game);
void EnDaiku2_Destroy(Actor* thisx, GameState* game);
void EnDaiku2_Update(Actor* thisx, GameState* game);
void EnDaiku2_Draw(Actor* thisx, GameState* game);
