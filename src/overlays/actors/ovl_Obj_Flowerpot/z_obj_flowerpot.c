...
void ObjFlowerpot_Init(Actor* thisx, GameState* game);
void ObjFlowerpot_Destroy(Actor* thisx, GameState* game);
void ObjFlowerpot_Update(Actor* thisx, GameState* game);
void ObjFlowerpot_Draw(Actor* thisx, GameState* game);
