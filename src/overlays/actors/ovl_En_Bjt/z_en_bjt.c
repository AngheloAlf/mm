...
void EnBjt_Init(Actor* thisx, GameState* game);
void EnBjt_Destroy(Actor* thisx, GameState* game);
void EnBjt_Update(Actor* thisx, GameState* game);
void EnBjt_Draw(Actor* thisx, GameState* game);
