...
void EnTwig_Init(Actor* thisx, GameState* game);
void EnTwig_Destroy(Actor* thisx, GameState* game);
void EnTwig_Update(Actor* thisx, GameState* game);
void EnTwig_Draw(Actor* thisx, GameState* game);
