...
void DemoMoonend_Init(Actor* thisx, GameState* game);
void DemoMoonend_Destroy(Actor* thisx, GameState* game);
void DemoMoonend_Update(Actor* thisx, GameState* game);
void DemoMoonend_Draw(Actor* thisx, GameState* game);
