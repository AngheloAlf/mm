...
void EnBomChu_Init(Actor* thisx, GameState* game);
void EnBomChu_Destroy(Actor* thisx, GameState* game);
void EnBomChu_Update(Actor* thisx, GameState* game);
void EnBomChu_Draw(Actor* thisx, GameState* game);
