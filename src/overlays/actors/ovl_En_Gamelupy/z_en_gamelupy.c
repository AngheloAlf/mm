...
void EnGamelupy_Init(Actor* thisx, GameState* game);
void EnGamelupy_Destroy(Actor* thisx, GameState* game);
void EnGamelupy_Update(Actor* thisx, GameState* game);
void EnGamelupy_Draw(Actor* thisx, GameState* game);
