...
void EnRz_Init(Actor* thisx, GameState* game);
void EnRz_Destroy(Actor* thisx, GameState* game);
void EnRz_Update(Actor* thisx, GameState* game);
void EnRz_Draw(Actor* thisx, GameState* game);
