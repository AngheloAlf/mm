...
void EnZog_Init(Actor* thisx, GameState* game);
void EnZog_Destroy(Actor* thisx, GameState* game);
void EnZog_Update(Actor* thisx, GameState* game);
void EnZog_Draw(Actor* thisx, GameState* game);
