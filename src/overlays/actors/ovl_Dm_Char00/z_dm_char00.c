...
void DmChar00_Init(Actor* thisx, GameState* game);
void DmChar00_Destroy(Actor* thisx, GameState* game);
void DmChar00_Update(Actor* thisx, GameState* game);
void DmChar00_Draw(Actor* thisx, GameState* game);
