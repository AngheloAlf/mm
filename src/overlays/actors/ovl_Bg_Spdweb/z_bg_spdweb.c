...
void BgSpdweb_Init(Actor* thisx, GameState* game);
void BgSpdweb_Destroy(Actor* thisx, GameState* game);
void BgSpdweb_Update(Actor* thisx, GameState* game);
void BgSpdweb_Draw(Actor* thisx, GameState* game);
