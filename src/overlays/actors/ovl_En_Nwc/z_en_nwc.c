...
void EnNwc_Init(Actor* thisx, GameState* game);
void EnNwc_Destroy(Actor* thisx, GameState* game);
void EnNwc_Update(Actor* thisx, GameState* game);
void EnNwc_Draw(Actor* thisx, GameState* game);
