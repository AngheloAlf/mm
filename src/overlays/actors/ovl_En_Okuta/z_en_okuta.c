...
void EnOkuta_Init(Actor* thisx, GameState* game);
void EnOkuta_Destroy(Actor* thisx, GameState* game);
void EnOkuta_Update(Actor* thisx, GameState* game);
void EnOkuta_Draw(Actor* thisx, GameState* game);
