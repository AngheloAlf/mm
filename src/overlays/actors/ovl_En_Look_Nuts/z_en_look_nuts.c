...
void EnLookNuts_Init(Actor* thisx, GameState* game);
void EnLookNuts_Destroy(Actor* thisx, GameState* game);
void EnLookNuts_Update(Actor* thisx, GameState* game);
void EnLookNuts_Draw(Actor* thisx, GameState* game);
