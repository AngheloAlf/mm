...
void ObjKibako2_Init(Actor* thisx, GameState* game);
void ObjKibako2_Destroy(Actor* thisx, GameState* game);
void ObjKibako2_Update(Actor* thisx, GameState* game);
void ObjKibako2_Draw(Actor* thisx, GameState* game);
