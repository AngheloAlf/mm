...
void BgDkjailIvy_Init(Actor* thisx, GameState* game);
void BgDkjailIvy_Destroy(Actor* thisx, GameState* game);
void BgDkjailIvy_Update(Actor* thisx, GameState* game);
void BgDkjailIvy_Draw(Actor* thisx, GameState* game);
