...
void ObjLift_Init(Actor* thisx, GameState* game);
void ObjLift_Destroy(Actor* thisx, GameState* game);
void ObjLift_Update(Actor* thisx, GameState* game);
void ObjLift_Draw(Actor* thisx, GameState* game);
