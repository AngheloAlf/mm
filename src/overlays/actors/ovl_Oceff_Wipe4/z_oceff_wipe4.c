...
void OceffWipe4_Init(Actor* thisx, GameState* game);
void OceffWipe4_Destroy(Actor* thisx, GameState* game);
void OceffWipe4_Update(Actor* thisx, GameState* game);
void OceffWipe4_Draw(Actor* thisx, GameState* game);
