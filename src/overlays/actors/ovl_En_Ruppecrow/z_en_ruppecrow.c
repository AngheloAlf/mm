...
void EnRuppecrow_Init(Actor* thisx, GameState* game);
void EnRuppecrow_Destroy(Actor* thisx, GameState* game);
void EnRuppecrow_Update(Actor* thisx, GameState* game);
void EnRuppecrow_Draw(Actor* thisx, GameState* game);
