...
void EnAob01_Init(Actor* thisx, GameState* game);
void EnAob01_Destroy(Actor* thisx, GameState* game);
void EnAob01_Update(Actor* thisx, GameState* game);
void EnAob01_Draw(Actor* thisx, GameState* game);
