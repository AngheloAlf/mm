...
void OceffWipe2_Init(Actor* thisx, GameState* game);
void OceffWipe2_Destroy(Actor* thisx, GameState* game);
void OceffWipe2_Update(Actor* thisx, GameState* game);
void OceffWipe2_Draw(Actor* thisx, GameState* game);
