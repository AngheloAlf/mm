...
void EnMk_Init(Actor* thisx, GameState* game);
void EnMk_Destroy(Actor* thisx, GameState* game);
void EnMk_Update(Actor* thisx, GameState* game);
void EnMk_Draw(Actor* thisx, GameState* game);
