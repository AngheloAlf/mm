...
void ObjHakaisi_Init(Actor* thisx, GameState* game);
void ObjHakaisi_Destroy(Actor* thisx, GameState* game);
void ObjHakaisi_Update(Actor* thisx, GameState* game);
void ObjHakaisi_Draw(Actor* thisx, GameState* game);
