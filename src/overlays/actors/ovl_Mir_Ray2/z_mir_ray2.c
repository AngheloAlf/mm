...
void MirRay2_Init(Actor* thisx, GameState* game);
void MirRay2_Destroy(Actor* thisx, GameState* game);
void MirRay2_Update(Actor* thisx, GameState* game);
void MirRay2_Draw(Actor* thisx, GameState* game);
