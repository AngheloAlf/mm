...
void EnGs_Init(Actor* thisx, GameState* game);
void EnGs_Destroy(Actor* thisx, GameState* game);
void EnGs_Update(Actor* thisx, GameState* game);
void EnGs_Draw(Actor* thisx, GameState* game);
