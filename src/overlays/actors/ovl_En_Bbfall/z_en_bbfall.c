...
void EnBbfall_Init(Actor* thisx, GameState* game);
void EnBbfall_Destroy(Actor* thisx, GameState* game);
void EnBbfall_Update(Actor* thisx, GameState* game);
void EnBbfall_Draw(Actor* thisx, GameState* game);
