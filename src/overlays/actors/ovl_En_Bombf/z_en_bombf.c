...
void EnBombf_Init(Actor* thisx, GameState* game);
void EnBombf_Destroy(Actor* thisx, GameState* game);
void EnBombf_Update(Actor* thisx, GameState* game);
void EnBombf_Draw(Actor* thisx, GameState* game);
