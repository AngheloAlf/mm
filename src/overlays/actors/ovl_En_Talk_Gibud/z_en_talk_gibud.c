...
void EnTalkGibud_Init(Actor* thisx, GameState* game);
void EnTalkGibud_Destroy(Actor* thisx, GameState* game);
void EnTalkGibud_Update(Actor* thisx, GameState* game);
void EnTalkGibud_Draw(Actor* thisx, GameState* game);
