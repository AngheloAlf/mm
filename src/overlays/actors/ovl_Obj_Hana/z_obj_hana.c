...
void ObjHana_Init(Actor* thisx, GameState* game);
void ObjHana_Destroy(Actor* thisx, GameState* game);
void ObjHana_Update(Actor* thisx, GameState* game);
void ObjHana_Draw(Actor* thisx, GameState* game);
