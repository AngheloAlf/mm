...
void ArrowLight_Init(Actor* thisx, GameState* game);
void ArrowLight_Destroy(Actor* thisx, GameState* game);
void ArrowLight_Update(Actor* thisx, GameState* game);
void ArrowLight_Draw(Actor* thisx, GameState* game);
