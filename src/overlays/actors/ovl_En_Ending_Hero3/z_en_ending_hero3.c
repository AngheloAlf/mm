...
void EnEndingHero3_Init(Actor* thisx, GameState* game);
void EnEndingHero3_Destroy(Actor* thisx, GameState* game);
void EnEndingHero3_Update(Actor* thisx, GameState* game);
void EnEndingHero3_Draw(Actor* thisx, GameState* game);
...
void EnEndingHero3_Init(Actor* thisx, GameState* game) {
    ...
    SkelAnime_InitSV(game, &this->skelAnime, &D_06007150, &D_06000E50, this->limbDrawTable,
