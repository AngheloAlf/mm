...
void EnBsb_Init(Actor* thisx, GameState* game);
void EnBsb_Destroy(Actor* thisx, GameState* game);
void EnBsb_Update(Actor* thisx, GameState* game);
void EnBsb_Draw(Actor* thisx, GameState* game);
