...
void EnTanron5_Init(Actor* thisx, GameState* game);
void EnTanron5_Destroy(Actor* thisx, GameState* game);
void EnTanron5_Update(Actor* thisx, GameState* game);
void EnTanron5_Draw(Actor* thisx, GameState* game);
