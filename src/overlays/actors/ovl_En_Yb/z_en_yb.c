...
void EnYb_Init(Actor* thisx, GameState* game);
void EnYb_Destroy(Actor* thisx, GameState* game);
void EnYb_Update(Actor* thisx, GameState* game);
void EnYb_Draw(Actor* thisx, GameState* game);
