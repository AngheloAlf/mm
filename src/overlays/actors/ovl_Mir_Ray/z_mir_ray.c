...
void MirRay_Init(Actor* thisx, GameState* game);
void MirRay_Destroy(Actor* thisx, GameState* game);
void MirRay_Update(Actor* thisx, GameState* game);
void MirRay_Draw(Actor* thisx, GameState* game);
