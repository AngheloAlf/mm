...
void EnTru_Init(Actor* thisx, GameState* game);
void EnTru_Destroy(Actor* thisx, GameState* game);
void EnTru_Update(Actor* thisx, GameState* game);
void EnTru_Draw(Actor* thisx, GameState* game);
