...
void OceffWipe_Init(Actor* thisx, GameState* game);
void OceffWipe_Destroy(Actor* thisx, GameState* game);
void OceffWipe_Update(Actor* thisx, GameState* game);
void OceffWipe_Draw(Actor* thisx, GameState* game);
