...
void ObjShutter_Init(Actor* thisx, GameState* game);
void ObjShutter_Destroy(Actor* thisx, GameState* game);
void ObjShutter_Update(Actor* thisx, GameState* game);
void ObjShutter_Draw(Actor* thisx, GameState* game);
