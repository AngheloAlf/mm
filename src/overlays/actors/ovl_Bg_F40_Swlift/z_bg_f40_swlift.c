...
void BgF40Swlift_Init(Actor* thisx, GameState* game);
void BgF40Swlift_Destroy(Actor* thisx, GameState* game);
void BgF40Swlift_Update(Actor* thisx, GameState* game);
void BgF40Swlift_Draw(Actor* thisx, GameState* game);
