...
void DmChar06_Init(Actor* thisx, GameState* game);
void DmChar06_Destroy(Actor* thisx, GameState* game);
void DmChar06_Update(Actor* thisx, GameState* game);
void DmChar06_Draw(Actor* thisx, GameState* game);
