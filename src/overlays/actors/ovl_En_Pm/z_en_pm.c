...
void EnPm_Init(Actor* thisx, GameState* game);
void EnPm_Destroy(Actor* thisx, GameState* game);
void EnPm_Update(Actor* thisx, GameState* game);
void EnPm_Draw(Actor* thisx, GameState* game);
