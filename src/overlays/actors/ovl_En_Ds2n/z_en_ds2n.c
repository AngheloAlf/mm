...
void EnDs2n_Init(Actor* thisx, GameState* game);
void EnDs2n_Destroy(Actor* thisx, GameState* game);
void EnDs2n_Update(Actor* thisx, GameState* game);
void EnDs2n_Draw(Actor* thisx, GameState* game);
