...
void EnFuKago_Init(Actor* thisx, GameState* game);
void EnFuKago_Destroy(Actor* thisx, GameState* game);
void EnFuKago_Update(Actor* thisx, GameState* game);
void EnFuKago_Draw(Actor* thisx, GameState* game);
