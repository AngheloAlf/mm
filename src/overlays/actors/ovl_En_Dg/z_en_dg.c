...
void EnDg_Init(Actor* thisx, GameState* game);
void EnDg_Destroy(Actor* thisx, GameState* game);
void EnDg_Update(Actor* thisx, GameState* game);
void EnDg_Draw(Actor* thisx, GameState* game);
