...
void Boss03_Init(Actor* thisx, GameState* game);
void Boss03_Destroy(Actor* thisx, GameState* game);
void Boss03_Update(Actor* thisx, GameState* game);
void Boss03_Draw(Actor* thisx, GameState* game);
