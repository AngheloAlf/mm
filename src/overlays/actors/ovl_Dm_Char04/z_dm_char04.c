...
void DmChar04_Init(Actor* thisx, GameState* game);
void DmChar04_Destroy(Actor* thisx, GameState* game);
void DmChar04_Update(Actor* thisx, GameState* game);
void DmChar04_Draw(Actor* thisx, GameState* game);
