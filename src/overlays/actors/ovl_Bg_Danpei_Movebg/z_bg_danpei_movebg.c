...
void BgDanpeiMovebg_Init(Actor* thisx, GameState* game);
void BgDanpeiMovebg_Destroy(Actor* thisx, GameState* game);
void BgDanpeiMovebg_Update(Actor* thisx, GameState* game);
