...
void EnTsn_Init(Actor* thisx, GameState* game);
void EnTsn_Destroy(Actor* thisx, GameState* game);
void EnTsn_Update(Actor* thisx, GameState* game);
void EnTsn_Draw(Actor* thisx, GameState* game);
