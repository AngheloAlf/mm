...
void EnTest7_Init(Actor* thisx, GameState* game);
void EnTest7_Destroy(Actor* thisx, GameState* game);
void EnTest7_Update(Actor* thisx, GameState* game);
void EnTest7_Draw(Actor* thisx, GameState* game);
