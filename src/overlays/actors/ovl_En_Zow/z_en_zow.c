...
void EnZow_Init(Actor* thisx, GameState* game);
void EnZow_Destroy(Actor* thisx, GameState* game);
void EnZow_Update(Actor* thisx, GameState* game);
void EnZow_Draw(Actor* thisx, GameState* game);
