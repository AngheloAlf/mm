...
void EnBaba_Init(Actor* thisx, GameState* game);
void EnBaba_Destroy(Actor* thisx, GameState* game);
void EnBaba_Update(Actor* thisx, GameState* game);
void EnBaba_Draw(Actor* thisx, GameState* game);
