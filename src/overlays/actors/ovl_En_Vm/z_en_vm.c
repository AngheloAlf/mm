...
void EnVm_Init(Actor* thisx, GameState* game);
void EnVm_Destroy(Actor* thisx, GameState* game);
void EnVm_Update(Actor* thisx, GameState* game);
void EnVm_Draw(Actor* thisx, GameState* game);
