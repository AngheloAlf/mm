...
void EnPr_Init(Actor* thisx, GameState* game);
void EnPr_Destroy(Actor* thisx, GameState* game);
void EnPr_Update(Actor* thisx, GameState* game);
void EnPr_Draw(Actor* thisx, GameState* game);
