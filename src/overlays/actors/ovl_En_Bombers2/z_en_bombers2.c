...
void EnBombers2_Init(Actor* thisx, GameState* game);
void EnBombers2_Destroy(Actor* thisx, GameState* game);
void EnBombers2_Update(Actor* thisx, GameState* game);
void EnBombers2_Draw(Actor* thisx, GameState* game);
