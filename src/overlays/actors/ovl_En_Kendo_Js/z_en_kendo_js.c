...
void EnKendoJs_Init(Actor* thisx, GameState* game);
void EnKendoJs_Destroy(Actor* thisx, GameState* game);
void EnKendoJs_Update(Actor* thisx, GameState* game);
void EnKendoJs_Draw(Actor* thisx, GameState* game);
