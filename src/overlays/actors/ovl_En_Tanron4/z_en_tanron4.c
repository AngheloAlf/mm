...
void EnTanron4_Init(Actor* thisx, GameState* game);
void EnTanron4_Destroy(Actor* thisx, GameState* game);
void EnTanron4_Update(Actor* thisx, GameState* game);
void EnTanron4_Draw(Actor* thisx, GameState* game);
