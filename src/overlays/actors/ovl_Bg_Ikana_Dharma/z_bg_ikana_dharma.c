...
void BgIkanaDharma_Init(Actor* thisx, GameState* game);
void BgIkanaDharma_Destroy(Actor* thisx, GameState* game);
void BgIkanaDharma_Update(Actor* thisx, GameState* game);
void BgIkanaDharma_Draw(Actor* thisx, GameState* game);
