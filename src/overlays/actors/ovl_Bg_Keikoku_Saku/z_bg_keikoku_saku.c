...
void BgKeikokuSaku_Init(Actor* thisx, GameState* game);
void BgKeikokuSaku_Destroy(Actor* thisx, GameState* game);
void BgKeikokuSaku_Update(Actor* thisx, GameState* game);
void BgKeikokuSaku_Draw(Actor* thisx, GameState* game);
