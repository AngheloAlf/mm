...
void EnBba01_Init(Actor* thisx, GameState* game);
void EnBba01_Destroy(Actor* thisx, GameState* game);
void EnBba01_Update(Actor* thisx, GameState* game);
void EnBba01_Draw(Actor* thisx, GameState* game);
