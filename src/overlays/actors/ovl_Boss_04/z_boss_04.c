...
void Boss04_Init(Actor* thisx, GameState* game);
void Boss04_Destroy(Actor* thisx, GameState* game);
void Boss04_Update(Actor* thisx, GameState* game);
void Boss04_Draw(Actor* thisx, GameState* game);
