...
void EnMs_Init(Actor* thisx, GameState* game);
void EnMs_Destroy(Actor* thisx, GameState* game);
void EnMs_Update(Actor* thisx, GameState* game);
void EnMs_Draw(Actor* thisx, GameState* game);
