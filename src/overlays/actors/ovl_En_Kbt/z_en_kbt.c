...
void EnKbt_Init(Actor* thisx, GameState* game);
void EnKbt_Destroy(Actor* thisx, GameState* game);
void EnKbt_Update(Actor* thisx, GameState* game);
void EnKbt_Draw(Actor* thisx, GameState* game);
