...
void EnShn_Init(Actor* thisx, GameState* game);
void EnShn_Destroy(Actor* thisx, GameState* game);
void EnShn_Update(Actor* thisx, GameState* game);
void EnShn_Draw(Actor* thisx, GameState* game);
