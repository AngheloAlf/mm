...
void EnDno_Init(Actor* thisx, GameState* game);
void EnDno_Destroy(Actor* thisx, GameState* game);
void EnDno_Update(Actor* thisx, GameState* game);
void EnDno_Draw(Actor* thisx, GameState* game);
