...
void EnSw_Init(Actor* thisx, GameState* game);
void EnSw_Destroy(Actor* thisx, GameState* game);
void EnSw_Update(Actor* thisx, GameState* game);
void EnSw_Draw(Actor* thisx, GameState* game);
