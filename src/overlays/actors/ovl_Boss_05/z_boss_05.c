...
void Boss05_Init(Actor* thisx, GameState* game);
void Boss05_Destroy(Actor* thisx, GameState* game);
void Boss05_Update(Actor* thisx, GameState* game);
void Boss05_Draw(Actor* thisx, GameState* game);
