...
void EnDnh_Init(Actor* thisx, GameState* game);
void EnDnh_Destroy(Actor* thisx, GameState* game);
void EnDnh_Update(Actor* thisx, GameState* game);
void EnDnh_Draw(Actor* thisx, GameState* game);
