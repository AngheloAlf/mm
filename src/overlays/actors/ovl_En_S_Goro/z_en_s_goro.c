...
void EnSGoro_Init(Actor* thisx, GameState* game);
void EnSGoro_Destroy(Actor* thisx, GameState* game);
void EnSGoro_Update(Actor* thisx, GameState* game);
void EnSGoro_Draw(Actor* thisx, GameState* game);
