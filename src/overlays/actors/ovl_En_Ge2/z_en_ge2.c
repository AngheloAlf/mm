...
void EnGe2_Init(Actor* thisx, GameState* game);
void EnGe2_Destroy(Actor* thisx, GameState* game);
void EnGe2_Update(Actor* thisx, GameState* game);
void EnGe2_Draw(Actor* thisx, GameState* game);
