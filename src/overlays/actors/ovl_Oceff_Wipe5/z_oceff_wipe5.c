...
void OceffWipe5_Init(Actor* thisx, GameState* game);
void OceffWipe5_Destroy(Actor* thisx, GameState* game);
void OceffWipe5_Update(Actor* thisx, GameState* game);
void OceffWipe5_Draw(Actor* thisx, GameState* game);
