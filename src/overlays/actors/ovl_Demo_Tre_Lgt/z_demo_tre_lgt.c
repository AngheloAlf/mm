...
void DemoTreLgt_Init(Actor* thisx, GameState* game);
void DemoTreLgt_Destroy(Actor* thisx, GameState* game);
void DemoTreLgt_Update(Actor* thisx, GameState* game);
void DemoTreLgt_Draw(Actor* thisx, GameState* game);
