...
void EnBomjimb_Init(Actor* thisx, GameState* game);
void EnBomjimb_Destroy(Actor* thisx, GameState* game);
void EnBomjimb_Update(Actor* thisx, GameState* game);
void EnBomjimb_Draw(Actor* thisx, GameState* game);
