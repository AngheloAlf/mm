...
void OceffWipe3_Init(Actor* thisx, GameState* game);
void OceffWipe3_Destroy(Actor* thisx, GameState* game);
void OceffWipe3_Update(Actor* thisx, GameState* game);
void OceffWipe3_Draw(Actor* thisx, GameState* game);
