...
void EnCow_Init(Actor* thisx, GameState* game);
void EnCow_Destroy(Actor* thisx, GameState* game);
void EnCow_Update(Actor* thisx, GameState* game);
void EnCow_Draw(Actor* thisx, GameState* game);
