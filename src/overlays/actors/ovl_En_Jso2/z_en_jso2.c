...
void EnJso2_Init(Actor* thisx, GameState* game);
void EnJso2_Destroy(Actor* thisx, GameState* game);
void EnJso2_Update(Actor* thisx, GameState* game);
void EnJso2_Draw(Actor* thisx, GameState* game);
