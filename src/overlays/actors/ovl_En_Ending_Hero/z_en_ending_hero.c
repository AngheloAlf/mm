...
void EnEndingHero_Init(Actor* thisx, GameState* game);
void EnEndingHero_Destroy(Actor* thisx, GameState* game);
void EnEndingHero_Update(Actor* thisx, GameState* game);
void EnEndingHero_Draw(Actor* thisx, GameState* game);
...
void EnEndingHero_Init(Actor* thisx, GameState* game) {
    ...
    SkelAnime_InitSV(game, &this->skelAnime, &D_0600B0CC, &D_06000BE0, this->limbDrawTable,
