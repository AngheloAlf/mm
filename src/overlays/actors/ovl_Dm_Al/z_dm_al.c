...
void DmAl_Init(Actor* thisx, GameState* game);
void DmAl_Destroy(Actor* thisx, GameState* game);
void DmAl_Update(Actor* thisx, GameState* game);
void DmAl_Draw(Actor* thisx, GameState* game);
