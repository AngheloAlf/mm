...
void EnHorse_Init(Actor* thisx, GameState* game);
void EnHorse_Destroy(Actor* thisx, GameState* game);
void EnHorse_Update(Actor* thisx, GameState* game);
void EnHorse_Draw(Actor* thisx, GameState* game);
