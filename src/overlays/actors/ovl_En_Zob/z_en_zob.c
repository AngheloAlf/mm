...
void EnZob_Init(Actor* thisx, GameState* game);
void EnZob_Destroy(Actor* thisx, GameState* game);
void EnZob_Update(Actor* thisx, GameState* game);
void EnZob_Draw(Actor* thisx, GameState* game);
