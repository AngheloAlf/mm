...
void EnRr_Init(Actor* thisx, GameState* game);
void EnRr_Destroy(Actor* thisx, GameState* game);
void EnRr_Update(Actor* thisx, GameState* game);
void EnRr_Draw(Actor* thisx, GameState* game);
