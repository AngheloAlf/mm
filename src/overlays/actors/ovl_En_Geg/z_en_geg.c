...
void EnGeg_Init(Actor* thisx, GameState* game);
void EnGeg_Destroy(Actor* thisx, GameState* game);
void EnGeg_Update(Actor* thisx, GameState* game);
void EnGeg_Draw(Actor* thisx, GameState* game);
