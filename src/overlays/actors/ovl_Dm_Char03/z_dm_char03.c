...
void DmChar03_Init(Actor* thisx, GameState* game);
void DmChar03_Destroy(Actor* thisx, GameState* game);
void DmChar03_Update(Actor* thisx, GameState* game);
void DmChar03_Draw(Actor* thisx, GameState* game);
