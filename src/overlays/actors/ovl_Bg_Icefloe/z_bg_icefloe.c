...
void BgIcefloe_Init(Actor* thisx, GameState* game);
void BgIcefloe_Destroy(Actor* thisx, GameState* game);
void BgIcefloe_Update(Actor* thisx, GameState* game);
void BgIcefloe_Draw(Actor* thisx, GameState* game);
