...
void EnTg_Init(Actor* thisx, GameState* game);
void EnTg_Destroy(Actor* thisx, GameState* game);
void EnTg_Update(Actor* thisx, GameState* game);
void EnTg_Draw(Actor* thisx, GameState* game);
