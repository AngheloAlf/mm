...
void DmChar02_Init(Actor* thisx, GameState* game);
void DmChar02_Destroy(Actor* thisx, GameState* game);
void DmChar02_Update(Actor* thisx, GameState* game);
void DmChar02_Draw(Actor* thisx, GameState* game);
