...
void EnGb2_Init(Actor* thisx, GameState* game);
void EnGb2_Destroy(Actor* thisx, GameState* game);
void EnGb2_Update(Actor* thisx, GameState* game);
void EnGb2_Draw(Actor* thisx, GameState* game);
