...
void EnEncount3_Init(Actor* thisx, GameState* game);
void EnEncount3_Destroy(Actor* thisx, GameState* game);
void EnEncount3_Update(Actor* thisx, GameState* game);
void EnEncount3_Draw(Actor* thisx, GameState* game);
