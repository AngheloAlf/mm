...
void EnZo_Init(Actor* thisx, GameState* game);
void EnZo_Destroy(Actor* thisx, GameState* game);
void EnZo_Update(Actor* thisx, GameState* game);
void EnZo_Draw(Actor* thisx, GameState* game);
