...
void BgKin2Bombwall_Init(Actor* thisx, GameState* game);
void BgKin2Bombwall_Destroy(Actor* thisx, GameState* game);
void BgKin2Bombwall_Update(Actor* thisx, GameState* game);
void BgKin2Bombwall_Draw(Actor* thisx, GameState* game);
