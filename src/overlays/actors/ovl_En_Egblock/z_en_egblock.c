...
void EnEgblock_Init(Actor* thisx, GameState* game);
void EnEgblock_Destroy(Actor* thisx, GameState* game);
void EnEgblock_Update(Actor* thisx, GameState* game);
void EnEgblock_Draw(Actor* thisx, GameState* game);
