...
void EnMm3_Init(Actor* thisx, GameState* game);
void EnMm3_Destroy(Actor* thisx, GameState* game);
void EnMm3_Update(Actor* thisx, GameState* game);
void EnMm3_Draw(Actor* thisx, GameState* game);
