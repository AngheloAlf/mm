...
void ObjSnowball_Init(Actor* thisx, GameState* game);
void ObjSnowball_Destroy(Actor* thisx, GameState* game);
void ObjSnowball_Update(Actor* thisx, GameState* game);
void ObjSnowball_Draw(Actor* thisx, GameState* game);
