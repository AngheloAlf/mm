...
void EnRu_Init(Actor* thisx, GameState* game);
void EnRu_Destroy(Actor* thisx, GameState* game);
void EnRu_Update(Actor* thisx, GameState* game);
void EnRu_Draw(Actor* thisx, GameState* game);
