...
void EnJs_Init(Actor* thisx, GameState* game);
void EnJs_Destroy(Actor* thisx, GameState* game);
void EnJs_Update(Actor* thisx, GameState* game);
void EnJs_Draw(Actor* thisx, GameState* game);
