...
void Boss01_Init(Actor* thisx, GameState* game);
void Boss01_Destroy(Actor* thisx, GameState* game);
void Boss01_Update(Actor* thisx, GameState* game);
void Boss01_Draw(Actor* thisx, GameState* game);
