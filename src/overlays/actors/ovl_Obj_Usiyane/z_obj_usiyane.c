...
void ObjUsiyane_Init(Actor* thisx, GameState* game);
void ObjUsiyane_Destroy(Actor* thisx, GameState* game);
void ObjUsiyane_Update(Actor* thisx, GameState* game);
void ObjUsiyane_Draw(Actor* thisx, GameState* game);
