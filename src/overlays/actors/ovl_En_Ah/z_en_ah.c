...
void EnAh_Init(Actor* thisx, GameState* game);
void EnAh_Destroy(Actor* thisx, GameState* game);
void EnAh_Update(Actor* thisx, GameState* game);
void EnAh_Draw(Actor* thisx, GameState* game);
