...
void EnTest_Init(Actor* thisx, GameState* game);
void EnTest_Destroy(Actor* thisx, GameState* game);
void EnTest_Update(Actor* thisx, GameState* game);
void EnTest_Draw(Actor* thisx, GameState* game);
