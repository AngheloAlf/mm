...
void EnZos_Init(Actor* thisx, GameState* game);
void EnZos_Destroy(Actor* thisx, GameState* game);
void EnZos_Update(Actor* thisx, GameState* game);
void EnZos_Draw(Actor* thisx, GameState* game);
