...
void EnMm_Init(Actor* thisx, GameState* game);
void EnMm_Destroy(Actor* thisx, GameState* game);
void EnMm_Update(Actor* thisx, GameState* game);
void EnMm_Draw(Actor* thisx, GameState* game);
