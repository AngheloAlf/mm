...
void EnDyExtra_Init(Actor* thisx, GameState* game);
void EnDyExtra_Destroy(Actor* thisx, GameState* game);
void EnDyExtra_Update(Actor* thisx, GameState* game);
void EnDyExtra_Draw(Actor* thisx, GameState* game);
...
void EnDyExtra_Draw(Actor* thisx, GameState* game) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               Gfx_TwoTexScroll(game->gfxCtx, 0, game->frames * 2, 0, 0x20, 0x40, 1,
                                game->frames, game->frames * -8, 0x10, 0x10));
