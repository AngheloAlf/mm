...
void EnKanban_Init(Actor* thisx, GameState* game);
void EnKanban_Destroy(Actor* thisx, GameState* game);
void EnKanban_Update(Actor* thisx, GameState* game);
void EnKanban_Draw(Actor* thisx, GameState* game);
