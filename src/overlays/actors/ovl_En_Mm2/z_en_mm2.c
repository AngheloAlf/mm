...
void EnMm2_Init(Actor* thisx, GameState* game);
void EnMm2_Destroy(Actor* thisx, GameState* game);
void EnMm2_Update(Actor* thisx, GameState* game);
void EnMm2_Draw(Actor* thisx, GameState* game);
