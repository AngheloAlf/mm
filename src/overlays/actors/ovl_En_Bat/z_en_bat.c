...
void EnBat_Init(Actor* thisx, GameState* game);
void EnBat_Destroy(Actor* thisx, GameState* game);
void EnBat_Update(Actor* thisx, GameState* game);
void EnBat_Draw(Actor* thisx, GameState* game);
