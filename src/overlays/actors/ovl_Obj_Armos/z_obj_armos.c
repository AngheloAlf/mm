...
void ObjArmos_Init(Actor* thisx, GameState* game);
void ObjArmos_Destroy(Actor* thisx, GameState* game);
void ObjArmos_Update(Actor* thisx, GameState* game);
void ObjArmos_Draw(Actor* thisx, GameState* game);
