...
void EnNb_Init(Actor* thisx, GameState* game);
void EnNb_Destroy(Actor* thisx, GameState* game);
void EnNb_Update(Actor* thisx, GameState* game);
void EnNb_Draw(Actor* thisx, GameState* game);
