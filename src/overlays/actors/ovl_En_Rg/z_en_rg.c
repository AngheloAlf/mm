...
void EnRg_Init(Actor* thisx, GameState* game);
void EnRg_Destroy(Actor* thisx, GameState* game);
void EnRg_Update(Actor* thisx, GameState* game);
void EnRg_Draw(Actor* thisx, GameState* game);
