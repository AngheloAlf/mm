...
void EnDodongo_Init(Actor* thisx, GameState* game);
void EnDodongo_Destroy(Actor* thisx, GameState* game);
void EnDodongo_Update(Actor* thisx, GameState* game);
void EnDodongo_Draw(Actor* thisx, GameState* game);
