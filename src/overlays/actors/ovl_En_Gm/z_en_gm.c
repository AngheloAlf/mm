...
void EnGm_Init(Actor* thisx, GameState* game);
void EnGm_Destroy(Actor* thisx, GameState* game);
void EnGm_Update(Actor* thisx, GameState* game);
void EnGm_Draw(Actor* thisx, GameState* game);
