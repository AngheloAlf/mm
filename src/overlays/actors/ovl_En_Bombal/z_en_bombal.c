...
void EnBombal_Init(Actor* thisx, GameState* game);
void EnBombal_Destroy(Actor* thisx, GameState* game);
void EnBombal_Update(Actor* thisx, GameState* game);
void EnBombal_Draw(Actor* thisx, GameState* game);
