...
void EnTab_Init(Actor* thisx, GameState* game);
void EnTab_Destroy(Actor* thisx, GameState* game);
void EnTab_Update(Actor* thisx, GameState* game);
void EnTab_Draw(Actor* thisx, GameState* game);
