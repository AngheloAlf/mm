...
void ObjYado_Init(Actor* thisx, GameState* game);
void ObjYado_Destroy(Actor* thisx, GameState* game);
void ObjYado_Update(Actor* thisx, GameState* game);
void ObjYado_Draw(Actor* thisx, GameState* game);
