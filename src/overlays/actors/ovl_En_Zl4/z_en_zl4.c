...
void EnZl4_Init(Actor* thisx, GameState* game);
void EnZl4_Destroy(Actor* thisx, GameState* game);
void EnZl4_Update(Actor* thisx, GameState* game);
void EnZl4_Draw(Actor* thisx, GameState* game);
