...
CHECK_WARNINGS := -Wall -Wextra -Wno-format-security -Wno-unknown-pragmas -Wno-unused-parameter -Wno-unused-variable -Wno-missing-braces -Wno-int-conversion -Wno-unused-but-set-variable -Wno-unused-label -Wno-return-type -Wno-implicit-fallthrough -Wno-sign-compare -Wno-tautological-compare -Wno-strict-aliasing -Wno-maybe-uninitialized
...
# Only code for now
C_FILES  := $(shell grep --recursive --files-without-match 'GLOBAL_ASM' src/ src/gcc_fix | grep '\.c')
