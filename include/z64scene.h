...
#define SCENE_CMD_ROOM_BEHAVIOR(currRoomUnk3, currRoomUnk2, currRoomUnk5, msgCtxunk12044, enablePosLights, kankyoContextUnkE2) \
...
#define SCENE_CMD_ACTOR_CUTSCENE_LIST(numActorCutscene, actorCutsceneList) \
    { SCENE_CMD_ID_ACTOR_CUTSCENE_LIST, numActorCutscene, CMD_PTR(actorCutsceneList) }

#define SCENE_CMD_MINIMAP_INFO(minimapInfo) \
    { SCENE_CMD_ID_MINIMAP_INFO, 0, CMD_PTR(minimapInfo) }

#define SCENE_CMD_MINIMAP_COMPASS_ICON_INFO(numCompassIcon, compassIconInfo) \
    { SCENE_CMD_ID_MINIMAP_COMPASS_ICON_INFO, numCompassIcon, CMD_PTR(compassIconInfo) }
